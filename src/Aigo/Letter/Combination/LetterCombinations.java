 ...
 * @Version 1.0.0
 */
public class LetterCombinations extends LetterCombinationSuper {
    /**
     *
     * @param digits
     * @return
     ...
     * @param resultList
     */
    private void countIndex(char[]ch,Map<Character,char[]> letterMap,String digits, int num,List<String> resultList) {
        // 根据当前数字， 找到对应的字符集合
     ...
     * @return
     */
    private String transferCharToString(char[] ch) {
