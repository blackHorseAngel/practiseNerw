...
/**
 *@Desprition 我们正在玩一个猜数游戏，游戏规则如下：
 * 从1到n之间选择一个数字.你来猜我选了哪个数字.如果你猜到正确的数字,就会赢得游戏.
...
public class GuessNumber2 {
    ...
    public static void main(String[] args) {
        int money = getMoneyAmount(10);
        System.out.println("需要最少的钱是：" + money);
    }
}
