...
//        findDepth(root, count);
    ...
    *
    ...
    private int findDepth(TreeNode node) {
        ...
        //记录
        int leftMaxLevel = findDepth(node.left);
        int rigthMaxLevel = findDepth(node.right);
        return Math.max(leftMaxLevel, rigthMaxLevel) + 1;
    }

    public static void main(String[] args) {
        MaxDepthV2 maxDepthV1 = new MaxDepthV2();
