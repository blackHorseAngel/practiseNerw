...
public class FindAllAnagrams {
    ...
    public static boolean checkLetter(int[]pcount,int[]tempCount){
    ...
    private static void resetFirst(char ch,int[]tempCount) {
       int num = ch - 'a';
       if(tempCount[num] != 0){
    ...
    //生成26个小写字母字符串数组
    public static int[]transferToArray(String s,int[]count){
