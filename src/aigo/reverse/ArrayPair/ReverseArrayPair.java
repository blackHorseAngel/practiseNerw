package aigo.reverse.ArrayPair;
 ...
 *@Version 1.0
 */
public class ReverseArrayPair extends ReverseArrayPairSuper {
    /**
     *@Description
     *@Author zhangshenming
     *@Param nums
     ...
     *@Return void
     */
    public void findReverseArray(int[]nums){
        if(nums.length < 2){
...
//        int[]nums = {2,1};
        ...
        ReverseArrayPair reverseArrayPair = new ReverseArrayPair();
        reverseArrayPair.findReverseArray(nums);
    }
}
